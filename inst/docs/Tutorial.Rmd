...
![](page6.png){width=100%}
This pane perform the actuall measurement of the trees.
...
Next, click the <kbd>Measure trees</kbd> button to run the individual tree segmentation. Once the segmentation is satisfactory, the user has the option to export each tree in the plantation as an individual point cloud using <kbd>Export trees</kbd>.
